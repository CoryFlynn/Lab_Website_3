...
var query1 = "SELECT * from football_games WHERE game_date < '2019-01-01' AND game_date > '2018-06-01';";
var query2 = "SELECT COUNT(*) FROM (SELECT * from football_games WHERE game_date < '2019-01-01' AND game_date > '2018-06-01') AS sub1 WHERE home_score > visitor_score;";
var query3 = "SELECT COUNT(*) FROM (SELECT * from football_games WHERE game_date < '2019-01-01' AND game_date > '2018-06-01') AS sub2 WHERE home_score < visitor_score;";
db.task('get-everything', task => {
    return task.batch([
        task.any(query1),
        task.any(query2),
...
app.get('/player_info/post', function(req,res){
  ...
  var query3 = "SELECT COUNT(*) FROM football_games WHERE (SELECT id FROM football_players WHERE id =" + pid + ") = ANY (football_games.players);"
  db.task('get-everything', task => {
    return task.batch([
        task.any(query1),
        task.any(query2),
